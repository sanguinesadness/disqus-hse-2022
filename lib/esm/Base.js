...
import { ACCESS_TOKEN_COOKIE, API_URL, USER_ROUTE, WEBSITE_TOKEN_COOKIE, } from "./config";
var BaseApi = /** @class */ (function () {
    function BaseApi(websiteToken, routeName) {
        ...
        this._axios.interceptors.request.use(function (config) {
            if (config.headers)
                config.headers.Authorization = "Bearer ".concat(_this._cookies.get(ACCESS_TOKEN_COOKIE));
            return config;
        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, axios.post(API_URL + USER_ROUTE + "/refresh", null, { withCredentials: true })];
                    case 1:
                        resp = _a.sent();
